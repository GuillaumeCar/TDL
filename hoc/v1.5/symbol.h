...
/* Fonctions pour obtenir les éléments de symbol_t en string */
...
/**
 * @brief Affiche SYMBOLE - CLASS - TYPE - NAME - VALUE - DESCRIPTION de la liste des symboles
 */
void dbgSymbolList();
/**
 * @brief Affiche la liste des symboles disponibles
 */
